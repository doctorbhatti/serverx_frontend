...
class _ExampleAppState extends State<ExampleApp> with SingleTickerProviderStateMixin {
    ...
    readServerList().then((List contents) {
      ...
      if (serverList.length > 0) {
        ...
        setState(() {
          tabText = 'Welcome';
          displayList.add(
            new DisplayItem(null, 'Welcome To serverX frontend', 'addServer', '', Icon(Icons.add, color: Colors.black), 'Click here to add server')
          );
        });
      }
    });
  ...
  void _setupStartScreen() {
    setState(() {
      ...
      displayList.clear();
      displayCache.clear();
      displayList.add(new DisplayItem(null, 'Welcome To serverX frontend', 'addServer', '', Icon(Icons.add, color: Colors.black), 'Click here to add server'));
    });
  }
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: <Widget>[
              Text( currentServer < 0 ? 'serverX' : serverList[currentServer].nickname),
              Visibility(
        ...
        drawer: Drawer(
          child: ListView(
            ...
            children: <Widget> [
              ListTile(
                title: Text('serverX Frontend', style: TextStyle(fontFamily: 'Jura', fontWeight: FontWeight.bold, fontSize: 28, color: Color(0xFFffab00)),),
                onTap: () { },
              ),
              Divider(),
              ListTile(
              ...
              ListTile(
                title: Text('About serverX', style: TextStyle(fontFamily: 'Jura', fontWeight: FontWeight.bold, fontSize: 17)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            Image(image: AssetImage('graphics/serverx-logo.png')),
            Container(height: 15,),
            Text('serverX Frontend v0.0.1lab',  style: TextStyle(fontFamily: 'Jura', color: Color(0xFF000000), fontWeight: FontWeight.bold, fontSize: 20)),
            Text('Lab Edition',  style: TextStyle(fontFamily: 'Jura', color: Color(0xFF000000), fontWeight: FontWeight.bold, fontSize: 20)),
            Container(height: 45,),
            Text('Developed By:',  style: TextStyle(fontFamily: 'Jura', color: Color(0xFF000000), fontWeight: FontWeight.bold, fontSize: 20)),
            Text('Haya Fatima',  style: TextStyle(fontFamily: 'Jura', color: Color(0xFF000000), fontWeight: FontWeight.bold, fontSize: 20)),
            Text('haya@papakakuttu.com',  style: TextStyle(fontFamily: 'Jura', color: Color(0xFF000000), fontWeight: FontWeight.bold, fontSize: 20)),
          ]
        )
      )
    );
